...
export interface PlatformaticPHPConfiguration {
  basePath?: string;
  server?: {
    hostname?: string;
    port?: number | string;
  ...
  php?: {
    ...
    docroot: string;
    /**
     * A sequence of conditional rewrites to apply to PHP requests
     */
    rewriter?: {
      /**
       * Logical operation with which to group conditions
       */
      operation?: "and" | "or";
      /**
       * Conditions to match before applying rewrites
       */
      conditions?: {
        type?: string;
        args?: string[];
      ...
      /**
       * Set of rewrites to apply if conditions are met
       *
       * @minItems 1
       */
      rewriters: [
